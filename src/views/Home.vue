<template>
  <div class="home">
    ...
    <p class="source">各省趋势数据由 <a href="https://github.com/BlankerL/DXY-COVID-19-Data">Isaac Lin</a> 采集自网络</p>
...
export default {
  ...
  methods: {
    ...
    checkLoadingFinish(){
      if(this.$data.csvReady && this.$data.corrReady && this.$data.timeseriesReady){
